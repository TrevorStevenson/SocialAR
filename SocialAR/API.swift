...
func getTopics(currentLocation: CLLocation, completion: @escaping ([Any]) -> Void)
{
    let requestUrl = "https://secure-river-29415.herokuapp.com/getTopics/\(currentLocation.coordinate.latitude)/\(currentLocation.coordinate.longitude)"
...
//    }
    ...
    let requestUrl = "https://secure-river-29415.herokuapp.com/nearestJobs/\(11510)"
